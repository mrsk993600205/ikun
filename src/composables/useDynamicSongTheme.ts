...
const applyDynamicTheme = (palette: DynamicThemePalette): void => {
  ...
  setThemeProperty(root, '--search-bg', palette.pageBg)
  setThemeProperty(root, '--search-content-bg', palette.elevatedBg)
  setThemeProperty(root, '--search-content-shadow', palette.shadowLight)
